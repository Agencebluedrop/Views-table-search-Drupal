...
namespace Drupal\views_tablesearch\Plugin\views\style;
 ...
 * @ViewsStyle(
 *   id = "tablesearch",
 *   title = @Translation("Views Table Search"),
 *   help = @Translation("Displays rows in a table with search option."),
 *   theme = "views_view_tablesearch",
 *   display_types = {"normal"}
 * )
 */
class TableSearch extends StylePluginBase implements CacheableDependencyInterface {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['casesensitivesearch'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('If the search is casesensitive'),
      '#default_value' => $this->options['casesensitivesearch'],
    ];
    $form['casesensitiveexpose'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Expose Case sensitive search to the user'),
      '#default_value' => $this->options['casesensitiveexpose'],
    ];

    $form['characters'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Number of caracters to start the search on'),
      '#description' => $this->t('The minimum number of characters when the table search should be fired'),
      '#default_value' => $this->options['characters'],
      '#maxlength' => 255,
    ];
    $form['highlight_color'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Highlight Color'),
      '#description' => $this->t('Highlight color of the search results, hexacode'),
      '#default_value' => $this->options['highlight_color'],
      '#maxlength' => 255,
    ];
    $form['highlight_element'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Highlight Element'),
      '#description' => $this->t('Highlight html element to wrap found results - by default choose span'),
      '#default_value' => $this->options['highlight_element'],
      '#maxlength' => 255,
    ];

    $form['highlight_class'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Highlight Class'),
      '#description' => $this->t('Highlight class to be given for highlighted found results'),
      '#default_value' => $this->options['highlight_class'],
      '#maxlength' => 255,
    ];
